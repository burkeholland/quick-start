...
- The signIn method now gets the email address from the observable via the `get` method. To change a value in an observable, the `set` method is used...<br>
    `user.set("email_address", "someone@domain.com")`
